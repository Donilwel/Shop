...
### `utils/`
По этому пути расположен файлы, которые отвечают за: Удобочитаемый вывод json'a; функцию для помещения или достатия из кэша, генерацию username (nickname) и генерация и миддлверка проверяющий и создающий JWT-токен
